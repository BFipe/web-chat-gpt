        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GPTUserId = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_APIKeys", x => x.APIKeyId);
                    table.ForeignKey(
                        name: "FK_APIKeys_AspNetUsers_GPTUserId",
                        column: x => x.GPTUserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChatHistories", x => x.GPTUserId);
                    table.ForeignKey(
                        name: "FK_ChatHistories_AspNetUsers_GPTUserId",
                        column: x => x.GPTUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
